...
public class DevicesFragment extends ListFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getListView().setBackgroundColor(getResources().getColor(R.color.dashboardBackground));
        getListView().setCacheColorHint(getResources().getColor(R.color.dashboardBackground));
